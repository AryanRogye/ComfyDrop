---
name: swiftui-pro
description: Comprehensively reviews SwiftUI code for best practices on modern APIs, maintainability, performance, and platform conventions across iOS and macOS. Use when reading, writing, or reviewing SwiftUI projects.
license: MIT
metadata:
  author: Paul Hudson
  version: "1.0"
...
1. If the code targets macOS or is shared across Apple platforms, load `references/macos.md` and validate desktop-specific layout, input, windowing, and command patterns.
...
- iOS 26 and macOS 26 exist, and new SwiftUI apps should be reviewed with current platform conventions in mind.
- Target Swift 6.2 or later, using modern Swift concurrency.
- Apply platform-aware guidance: do not report an iOS-only convention as a problem in macOS code, or vice versa.
- As a SwiftUI developer, the user will want to avoid UIKit or AppKit unless requested.
...
- `references/macos.md` - desktop-specific guidance for windowing, menus, keyboard interaction, and macOS layout choices.
